...
public final class Const {
    ...
    public final static String LIMIT_IMAGE = "limit_image";
    public final static String LIMIT_COMMENT = "limit_comment";
    public final static String FORUM_PREVIEW_CACHE = "forum:preview:";
