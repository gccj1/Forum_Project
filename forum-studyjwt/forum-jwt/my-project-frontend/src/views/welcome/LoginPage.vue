<template>
  <div style="text-align: center;margin: 0 20px">
    <div style="margin-top: 170px">
      <div style="font-size: 35px;font-weight: bold;margin-bottom: 20px;">XXX论坛</div>
      <div style="font-size: 15px;color: grey;border: 2px solid yellowgreen;border-radius: 5px;
      padding: 5px;
      margin-bottom: 30px;">交友、恋爱、吐槽、种草、一切你想……</div>
      <div style="font-size: 24px;font-weight: bolder">请登录</div>
    </div>
